...
egg.bnf({
  rules: {
    ...
    "literal-type-property": { sequence: ["type-expression", "identifier-property", {zeroOrOne: {sequence: [{token: "("}, {zeroOrOne: "definition-function-parameter-list"}, {token: ")"}]}}], railroad: false }
  },
  variations: {
    full: {
