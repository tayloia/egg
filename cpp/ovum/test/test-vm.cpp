...
#define EXPR_UNARY(op, arg) mbuilder->exprValueUnaryOp(ValueUnaryOp::op, arg, {})
#define EXPR_BINARY(op, lhs, rhs) mbuilder->exprValueBinaryOp(ValueBinaryOp::op, lhs, rhs, {})
#define EXPR_TERNARY(op, lhs, mid, rhs) mbuilder->exprValueTernaryOp(ValueTernaryOp::op, lhs, mid, rhs, {})
...
#define STMT_IF_ELSE(cond, truthy, falsy) mbuilder->stmtIfElse(cond, truthy, falsy, {})
#define STMT_WHILE(cond, block) mbuilder->stmtWhile(cond, block, {})
#define STMT_DO(block, cond) mbuilder->stmtDo(block, cond, {})
#define STMT_FOR_LOOP(initial, condition, advance, block) mbuilder->stmtForLoop(initial, condition, advance, block, {})
...
#define STMT_PROP_MUTATE(instance, property, op, value) mbuilder->stmtPropertyMutate(instance, property, ValueMutationOp::op, value, {})
#define STMT_PROP_SET(instance, property, value) STMT_PROP_MUTATE(instance, property, Assign, value)
...
#define STMT_VAR_MUTATE(symbol, op, value) mbuilder->stmtVariableMutate(mbuilder->createString(symbol), ValueMutationOp::op, value, {})
#define STMT_VAR_SET(symbol, value) STMT_VAR_MUTATE(symbol, Assign, value)
...
#define STMT_CATCH(symbol, type, ...) mbuilder->glue(mbuilder->stmtCatch(mbuilder->createString(symbol), type, {}) COMMA(__VA_ARGS__))
