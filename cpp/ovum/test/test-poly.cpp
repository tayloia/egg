...
TEST(TestPoly, CreateSoftValue) {
  ...
  ASSERT_EQ(egg::ovum::ValueFlags::Void, soft->getFlags());
...
TEST(TestPoly, SoftValueNull) {
  ...
  ASSERT_EQ(egg::ovum::ValueFlags::Null, soft->getFlags());
...
TEST(TestPoly, SoftValueBool) {
  ...
  ASSERT_EQ(egg::ovum::ValueFlags::Bool, soft->getFlags());
...
TEST(TestPoly, SoftValueInt) {
  ...
  ASSERT_EQ(egg::ovum::ValueFlags::Int, soft->getFlags());
...
TEST(TestPoly, SoftValueFloat) {
  ...
  ASSERT_EQ(egg::ovum::ValueFlags::Float, soft->getFlags());
...
TEST(TestPoly, SoftValueString) {
  ...
  ASSERT_EQ(egg::ovum::ValueFlags::String, soft->getFlags());
...
TEST(TestPoly, SoftValueObject) {
  ...
  ASSERT_EQ(egg::ovum::ValueFlags::Object, soft->getFlags());
