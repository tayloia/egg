...
TEST(TestString, IndexOfCodePoint) {
  egg::test::Allocator allocator;
...
TEST(TestString, LastIndexOfCodePoint) {
  egg::test::Allocator allocator;
...
TEST(TestString, LastIndexOfString) {
  egg::test::Allocator allocator;
