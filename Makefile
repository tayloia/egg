...
# WIBBLE EGG_SRCS = $(call sources,ovum/*.cpp yolk/*.cpp)
# WIBBLE TEST_SRCS = $(call sources,ovum/test/*.cpp yolk/test/*.cpp)
EGG_SRCS = $(call sources,ovum/*.cpp)
TEST_SRCS = $(call sources,ovum/test/*.cpp)
