...
TEST(TestStreams, FileTextStreamLastLine) {
  ASSERT_EQ(213u, lastLine("~/cpp/test/data/utf-8-demo.txt"));
  ASSERT_EQ(213u, lastLine("~/cpp/test/data/utf-8-demo.cr.txt"));
  ASSERT_EQ(213u, lastLine("~/cpp/test/data/utf-8-demo.lf.txt"));
}
