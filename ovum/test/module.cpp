...
TEST(TestModule, OpcodeFromMachineByte) {
  ...
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(24));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(25));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(26));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(27));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(28));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(29));
  ASSERT_EQ(Opcode::ANY, Module::opcodeFromMachineByte(30));
  ASSERT_EQ(Opcode::ASSERT, Module::opcodeFromMachineByte(31));
  ASSERT_EQ(Opcode::ASSIGN, Module::opcodeFromMachineByte(32));
  ASSERT_EQ(Opcode::CATCH, Module::opcodeFromMachineByte(33));
  ASSERT_EQ(Opcode::FOR, Module::opcodeFromMachineByte(34));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(35));
  ASSERT_EQ(Opcode::ANYQ, Module::opcodeFromMachineByte(36));
  ...
  ASSERT_EQ(Opcode::DO, Module::opcodeFromMachineByte(44));
  ASSERT_EQ(Opcode::GUARD, Module::opcodeFromMachineByte(45));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(46));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(47));
  ASSERT_EQ(Opcode::CONTINUE, Module::opcodeFromMachineByte(48));
  ASSERT_EQ(Opcode::IDENTIFIER, Module::opcodeFromMachineByte(49));
  ASSERT_EQ(Opcode::INDEX, Module::opcodeFromMachineByte(50));
  ...
  ASSERT_EQ(Opcode::FALSE, Module::opcodeFromMachineByte(54));
  ASSERT_EQ(Opcode::INCREMENT, Module::opcodeFromMachineByte(55));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(56));
  ...
  ASSERT_EQ(Opcode::FINITE, Module::opcodeFromMachineByte(60));
  ASSERT_EQ(Opcode::ITERABLE, Module::opcodeFromMachineByte(61));
  ASSERT_EQ(Opcode::NAMED, Module::opcodeFromMachineByte(62));
  ...
  ASSERT_EQ(Opcode::INFERRED, Module::opcodeFromMachineByte(66));
  ASSERT_EQ(Opcode::NOT, Module::opcodeFromMachineByte(67));
  ASSERT_EQ(Opcode::PROPERTY, Module::opcodeFromMachineByte(68));
  ...
  ASSERT_EQ(Opcode::NOOP, Module::opcodeFromMachineByte(72));
  ASSERT_EQ(Opcode::POINTEE, Module::opcodeFromMachineByte(73));
  ASSERT_EQ(Opcode::PROPERTYQ, Module::opcodeFromMachineByte(74));
  ...
  ASSERT_EQ(Opcode::NULL_, Module::opcodeFromMachineByte(78));
  ASSERT_EQ(Opcode::POINTER, Module::opcodeFromMachineByte(79));
  ASSERT_EQ(Opcode::WHILE, Module::opcodeFromMachineByte(80));
  ...
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(104));
  ...
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(246));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(247));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(248));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(249));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(250));
  ASSERT_EQ(Opcode::reserved, Module::opcodeFromMachineByte(251));
...
TEST(TestModule, OpcodeEncode0) {
  ASSERT_EQ(78, OpcodeProperties::from(Opcode::NULL_).encode(0));
...
TEST(TestModule, OpcodeEncode4) {
  ...
  ASSERT_EQ(34, OpcodeProperties::from(Opcode::FOR).encode(4));
