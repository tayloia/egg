...
TEST(TestModule, OpcodeFromMachineByte) {
  ...
  ASSERT_EQ(OPCODE_VARARGS, Module::opcodeFromMachineByte(116));
  ASSERT_EQ(OPCODE_VARARGS, Module::opcodeFromMachineByte(117));
  ASSERT_EQ(OPCODE_VARARGS, Module::opcodeFromMachineByte(118));
  ASSERT_EQ(OPCODE_VARARGS, Module::opcodeFromMachineByte(119));
  ...
  ASSERT_EQ(OPCODE_reserved, Module::opcodeFromMachineByte(134));
  ASSERT_EQ(OPCODE_reserved, Module::opcodeFromMachineByte(135));
  ASSERT_EQ(OPCODE_reserved, Module::opcodeFromMachineByte(136));
  ASSERT_EQ(OPCODE_reserved, Module::opcodeFromMachineByte(137));
  ...
  ASSERT_EQ(OPCODE_TRY, Module::opcodeFromMachineByte(147));
  ASSERT_EQ(OPCODE_TRY, Module::opcodeFromMachineByte(148));
  ASSERT_EQ(OPCODE_TRY, Module::opcodeFromMachineByte(149));
